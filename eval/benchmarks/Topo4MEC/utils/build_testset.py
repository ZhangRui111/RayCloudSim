...
def main():
    ...
    flag, num_arrivals_per_ingress, lambda_ = '25N50E', 200, 0.25
    # flag, num_arrivals_per_ingress, lambda_ = '50N50E', 200, 0.125
    # flag, num_arrivals_per_ingress, lambda_ = '100N150E', 200, 0.0625
    # flag, num_arrivals_per_ingress, lambda_ = 'MilanCityCenter', 200, 0.14286
